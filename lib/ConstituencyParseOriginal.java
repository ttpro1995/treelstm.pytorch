...
public class ConstituencyParseOriginal {
  ...
  public ConstituencyParseOriginal(String tokPath, String parentPath, boolean tokenize) throws IOException {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (!props.containsKey("parentpath")) {
      System.err.println(
        "usage: java ConstituencyParseOriginal -deps - -tokenize - -tokpath <tokpath> -parentpath <parentpath>");
      System.exit(1);
    }
    ...
    ConstituencyParseOriginal processor = new ConstituencyParseOriginal(tokPath, parentPath, tokenize);
